...
mlflow.set_tracking_uri('https://dagshub.com/Kushagra-Bisht/mlflow-dagshub-demo.mlflow')

import dagshub
dagshub.init(repo_owner='Kushagra-Bisht', repo_name='mlflow-dagshub-demo', mlflow=True)
